...
You can find the Launchpad repository here: https://github.com/todomagichere/launchpad

## Install and use

1. Install the launchpad with **curl** OR **wget**:
```sh
$ curl -LSs https://todomagichere.github.io/launchpad/install_curl.bash | bash

# OR

$ wget -O - "https://todomagichere.github.io/launchpad/install_wget.bash" | bash
```
